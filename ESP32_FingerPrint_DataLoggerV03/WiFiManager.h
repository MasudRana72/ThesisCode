...
bool writeToMemory(String ssid_get, String pass_get) {
  char buff1[30];
  char buff2[30];
  ssid_get.toCharArray(buff1, 30);
  pass_get.toCharArray(buff2, 30);
